    ...
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat p-4" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1579546929662-711aa81148cf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80")' }}>
      ...
      <div className="relative z-10 max-w-md w-full mx-4">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="rounded-md -space-y-px">
                {!isLogin && (
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      required={!isLogin}
                      className="appearance-none rounded-none relative block w-full px-4 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-lg focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    style={!isLogin ? {} : { borderTopLeftRadius: '0.5rem', borderTopRightRadius: '0.5rem' }}
                  />
                </div>
                <div>
          ...
          {/* Pied de page avec un fond plus sombre */}
          <div className="bg-gray-50 px-8 py-6 rounded-b-2xl">
            <div className="text-center text-sm text-gray-600">
              <p>En vous connectant, vous acceptez nos <a href="#" className="font-medium text-indigo-600 hover:text-indigo-500">Conditions d'utilisation</a> et notre <a href="#" className="font-medium text-indigo-600 hover:text-indigo-500">Politique de confidentialité</a>.</p>
            </div>
          </div>
        </div>
      </div>
