...
const Contact = () => {
  ...
  return (
    <div className="bg-white py-16 md:py-24 px-4 sm:px-6 lg:px-8" id='contact'>
      <div className="max-w-8xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-md text-gray-700 max-w-2xl mx-auto">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum cumque esse culpa sunt ex, fugiat facere.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-1/2">
            <form onSubmit={handleSubmit} className="bg-gray-50 rounded-xl px-6 py-12 shadow-md">
              ...
              <button
                type="submit"
                className="w-full bg-gray-900 hover:bg-gray-800 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-300 transform hover:scale-105"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-gray-900 text-white rounded-xl overflow-hidden shadow-md h-full">
              {/* Image en haut */}
              <div className="h-48 overflow-hidden">
                <img 
                  src="https://images.unsplash.com/photo-1560448204-603b3fc33ddc?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
                  alt="Our office" 
                ...
                <div className="space-y-6 grid md:grid-cols-2 gap-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">123 Property Avenue<br />Paris, 75000<br />France</p>
                    </div>
                  </div>
